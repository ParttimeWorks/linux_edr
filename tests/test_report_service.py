...
class TestReportService(unittest.TestCase):
    ...
    @patch(
        "linux_edr.application.services.severity_calculator.SeverityCalculator.calculate_from_lower_reports"
    )
    ...
    @patch(
        "linux_edr.application.services.severity_calculator.SeverityCalculator.calculate_risk_score"
    )
    ...
    def test_unusual_activity_detection(self):
        ...
        self.assertGreaterEqual(
            len(daily_data["unusual_activity"]), 3
        )  # Blocks 4-6 should be flagged
