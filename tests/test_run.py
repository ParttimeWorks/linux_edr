...
class TestAppRun(unittest.TestCase):
    ...
    def test_run_normal_operation(self, mock_logging, mock_scheduler, mock_report_manager, 
    ...
    @patch('linux_edr.app.BackgroundScheduler')
    @patch('linux_edr.app.logging')
    def test_run_keyboard_interrupt(self, mock_logging, mock_scheduler, mock_report_manager, 
                                mock_reporter, mock_aggregator, mock_trace_reader, mock_config):
