        ...
        if self.reporter:
            ...
            if monthly_report.analysis:
                ...
                for line in lines:
                    ...
                    if line.lower() in ["recommendations:", "recommendations", "strategic recommendations:", "strategic recommendations", "security recommendations:", "security recommendations"]:
                        rec_section = True
                        continue
                ...
                if not ai_recommendations:
                    for line in lines:
                        line = line.strip()
                        if line.lower().startswith(("update ", "implement ", "enable ", "configure ", "review ", "monitor ")):
